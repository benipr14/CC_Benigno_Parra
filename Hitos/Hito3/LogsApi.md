...
* Logs de aplicación (recomendado en servicios):
...
* Rotación de ficheros:
    ...
    Justificación: rotación por tamaño es simple y evita que un fichero de log crezca indefinidamente; los valores por defecto (10MB, 5 backups) equilibran retención y uso de disco para una app de práctica.
* Handlers:
    Console: StreamHandler (stdout) para desarrollo y logs en CI.
