...
En resumen: la combinación de tres réplicas idénticas y un contenedor de datos permite demostrar escalado horizontal básico, persistencia compartida y consistencia de despliegue sin introducir complejidad de orquestadores completos.